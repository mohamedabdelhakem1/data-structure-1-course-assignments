...
public class Stringtest {
	...
	public void test1() {
		...
		String[] players = { "33JUBU33", "3U3O4433", "O33P44NB", "PO3NSDP3", "VNDSD333", "OINFD33X" };
	...
	public void test2() {
		Icehockey icehockey = new Icehockey();
		String[] players = new String[] { "44444H44S4", "K444K4L444", "4LJ44T44XH", "444O4VIF44", "44C4D4U444",
	...
	public void test3() {
		Icehockey icehockey = new Icehockey();
		String[] players = new String[] { "8D88888J8L8E888", "88NKMG8N8E8JI88", "888NS8EU88HN8EO", "LUQ888A8TH8OIH8",
		...
		Point[] point = new Point[] { new Point(1, 17), new Point(3, 3), new Point(3, 10), new Point(3, 25),
	...
	public void test4() {
		...
		Point[] point = new Point[] { new Point(5, 5), new Point(5, 5) };
		Assert.assertArrayEquals(point, thepoints);
	...
	public void test5() {
		Icehockey icehockey = new Icehockey();
		String[] players = new String[] { "11111", "1A1A1", "1a1a1", "1A1A1", "11111" };
		Point[] thepoints = icehockey.findPlayers(players, 1, 3);
	...
	public void test6() {
		...
		players = new String[] { "8D88888J8L8E888", "88NKMG8N8E8JI88", "888NS8EU88HN8EO", "LUQ888A8TH8OIH8",
				"888QJ88R8SG88TY", "88ZQV88B88OUZ8O", "FQ88WF8Q8GG88B8", "8S888HGSB8FT8S8", "8MX88D88888T8K8",
				"8S8A88MGVDG8XK8", "M88S8B8I8M88J8N", "8W88X88ZT8KA8I8", "88SQGB8I8J88W88", "U88H8NI8CZB88B8",
				"8PK8H8T8888TQR8" };
		thepoints = icehockey.findPlayers(players, 8, 9);
		point = new Point[] { new Point(1, 17), new Point(3, 3), new Point(3, 10), new Point(3, 25), new Point(5, 21),
